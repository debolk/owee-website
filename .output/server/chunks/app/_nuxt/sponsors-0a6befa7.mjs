...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<a id="link" class="${ssrRenderClass([{ mobile: _ctx.$device.isMobile }, "center"])}" href="https://www.facebook.com/profile.php?id=100057201169713" target="_blank"><img class="${ssrRenderClass({ mobile: _ctx.$device.isMobile })}"${ssrRenderAttr("src", _imports_0)} alt="MW Transportservice"></a></div></div>`);
    };
  }
};
...
//# sourceMappingURL=sponsors-0a6befa7.mjs.map
