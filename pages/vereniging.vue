<template>
  <div id="vereniging">
    ...
    <div v-if="$cookie.get('language') == 'dutch'" class="content">
      <h2>WAT VOOR VERENIGING<br>ZIJN WIJ?</h2>
    ...
    <div v-if="$cookie.get('language') == 'english'" class="content">
      <h2>WHAT KIND OF ASSOCIATION<br>ARE WE?</h2>
